...
import { Clock, Currency, Pause, Play } from 'lucide-react';
...
export const AlbumPage = () => {
    ...
    const handlePlayAlbum = () => { 
        ...
        if (iscurrentAlbumPlaying) togglePlay();
            ...
            //start playing album from beggining
            ...
            <div className='relative min-h-screen'>
                ...
                <div className='relative z-10'>
                    ...
                    <div className='px-6 pb-4 flex items-center gap-6'>
                        <Button 
                            ...
                            {isPlaying && currentAlbum?.songs.some((song) => song._id === currentSong?._id) ? (
                                <Pause className='h-7 w-7 text-balck'/>
                            ) :(
                                <Play className='h-7 w-7 text-balck' /> 
                            )}
                        </Button>
                    </div>
                    ...
                    <div className='bg-black/20 backdrop-blur-sm'>
                        ...
                        {/* table header */}
                        <div className='grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-10 py-2 text-sm text-zinc-400 border-b
                            border-white/5'>
                            <div>#</div>
                            <div>Title</div>
